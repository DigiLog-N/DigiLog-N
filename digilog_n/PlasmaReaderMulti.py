...
class PlasmaReaderMulti:
    def __init__(self, file_path, key_prefixes, remove_after_reading=False):
    ...
    def _get_keys(self):
        ...
        for key_prefix in self.key_prefixes:
            new_l += [x for x in l if x.startswith(key_prefix)]
