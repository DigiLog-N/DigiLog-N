...
if __name__ == '__main__':
    ...
    ds.add_field('ct_timestamp', 'seconds', 3, 'CloudTurbine introduced epoch timestamp', 'double')
    ds.add_field('unit', None, None, 'engine unit', 'int')
    ds.add_field('time', 'cycle', None, 'one cycle is assumed to be one take-off + flight-time + one landing', 'int')
